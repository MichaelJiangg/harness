...
当前进行中的改动为模型级热切换、终端输入与中断上下文修复：`/model` 直接列出并切换 `deepseek-flash`、`deepseek-pro`、`glm-5.3-flash`、`glm-5.3-pro`；Esc 中断时固化可见前缀并写回会话上下文，下一轮可继续未完成内容。V1.0.4 已发布。

最近公开版本为 [V1.0.4 — bugfix-上下文断档](https://github.com/MichaelJiangg/harness/releases/tag/v1.0.4) ，仓库为 [MichaelJiangg/harness](https://github.com/MichaelJiangg/harness) ，标签为 `v1.0.4`。
